...
<div class="form-grid">
    ...
    <div class="wide reniec-action" data-reniec-action><button class="secondary outline" type="button" data-consultar-reniec>Consultar DNI</button><span data-reniec-status role="status">También puede ingresar los datos manualmente.</span></div>
...
moduloCrud(
    ...
    ['id' => 'id_cliente', 'grupo' => 'VENTAS', 'scripts' => ['resources/js/reniec.js', 'resources/js/clientes.js']]
);
